...
.oi__meta{font-size:clamp(13px,1.1vw,15px);line-height:1.5;color:rgba(233,240,246,.88);margin:0 0 12px}
...
.oi__phone-note{color:rgba(233,240,246,.82);font-weight:400}
