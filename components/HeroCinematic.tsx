...
.hero-cine__video{width:100%;height:100%;object-fit:cover;opacity:1}
.hero-cine__veil{position:absolute;inset:0;background:linear-gradient(180deg,transparent 60%,rgba(10,14,20,.5) 86%,var(--bg))}
.hero-cine__glow{position:absolute;inset:0;pointer-events:none;background:radial-gradient(70% 60% at 18% 42%,rgba(10,14,20,.28),transparent 62%)}
...
.hero-cine__badge{display:inline-flex;align-items:center;gap:10px;font-family:var(--font-mono);font-size:12px;letter-spacing:2px;text-transform:uppercase;color:var(--cyan);border:1px solid var(--border-glow);background:rgba(10,14,20,.35);backdrop-filter:blur(4px);padding:8px 14px;border-radius:999px;margin-bottom:24px}
...
.hero-cine__title{font-family:var(--font-sans);font-weight:800;font-size:clamp(44px,8vw,120px);line-height:.9;letter-spacing:-.03em;color:var(--text);text-shadow:0 2px 12px rgba(0,0,0,.6),0 10px 44px rgba(0,0,0,.5);margin:0}
...
.hero-cine__lead{margin-top:22px;max-width:46ch;font-size:clamp(16px,1.5vw,20px);line-height:1.55;color:#eef4f8;text-shadow:0 2px 6px rgba(0,0,0,.75),0 2px 20px rgba(0,0,0,.7)}
...
.hero-cine__trust{margin-top:26px;display:flex;flex-wrap:wrap;gap:22px;font-family:var(--font-mono);font-size:11px;letter-spacing:1px;text-transform:uppercase;color:#c7d2de;text-shadow:0 1px 6px rgba(0,0,0,.7)}
.hero-cine__scroll{position:absolute;bottom:22px;left:50%;transform:translateX(-50%);z-index:2;font-family:var(--font-mono);font-size:10px;letter-spacing:2px;text-transform:uppercase;color:#c7d2de;text-align:center;text-shadow:0 1px 6px rgba(0,0,0,.7)}
...
@media(max-width:640px){.hero-cine__inner{padding-top:104px}}
`;
