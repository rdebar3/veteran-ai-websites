...
.iq__eyebrow{font-family:var(--font-sans);font-size:13px;font-weight:500;letter-spacing:.2em;text-transform:uppercase;color:rgba(233,240,246,.82);margin:0 0 16px}
...
.iq__field{width:100%;font-family:var(--font-sans);font-size:15px;color:#eef4f8;background:rgba(255,255,255,.04);border:1px solid rgba(233,240,246,.22);border-radius:12px;padding:13px 15px;transition:border-color .2s}
.iq__field:focus{outline:2px solid #e3b23c;outline-offset:2px;border-color:transparent}
.iq__field::placeholder{color:rgba(233,240,246,.62)}
        ...
        {done ? (
          ...
          <form className="iq__form" onSubmit={submit}>
            ...
            <div className="iq__row">
              ...
              <div>
                <label className="iq__label" htmlFor="iq-business">
                  Business name
                </label>
                <input
                  id="iq-business"
            ...
            <div className="iq__row">
              <div>
                <label className="iq__label" htmlFor="iq-email">
                  Email
                </label>
                <input
                  id="iq-email"
              ...
              <div>
                <label className="iq__label" htmlFor="iq-phone">
                  Phone
                </label>
                <input
                  id="iq-phone"
            ...
            <div className="iq__block">
              <label className="iq__label" htmlFor="iq-type">
                What do you need?
              </label>
              <select
                id="iq-type"
            ...
            <div className="iq__block">
              <label className="iq__label" htmlFor="iq-message">
              ...
              <textarea
                ...
                placeholder="What kind of site are you looking for? Any examples you like, timeline, or goals?"
                required
              />
            </div>
